      ...
      <div class="router-tab-scroll">
        ...
        >
          <router-link
            ...
            @mouseenter.native="itemOnMouseenter"
            @mouseleave.native="itemOnMouseleave"
          >
            <slot v-bind="{ tab: items[index], tabs: items, index }">
              ...
              <span class="_border-left"></span>
              <span class="_border-right"></span>
            </slot>
          </router-link>
        </transition-group>
      </div>
